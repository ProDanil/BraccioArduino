...
public:
  ...
  */
   ...
   */
  int ServoMovement(int delay, int Vbase,int Vshoulder, int Velbow, int Vwrist_ver, int Vwrist_rot, int Vgripper, void (*callback)(int,int,int,int,int,int,int,int,int,int,int,int) = 0);
