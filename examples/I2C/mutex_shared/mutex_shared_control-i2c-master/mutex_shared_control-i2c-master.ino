...
void update_leds() {
    digitalWrite(LAMP_X1_PIN, occupied_Z1);
    digitalWrite(LAMP_X2_PIN, occupied_Z2);
    digitalWrite(LAMP_X3_PIN, occupied_Z3);
    digitalWrite(MUTEX_LAMP_PIN, mutex.acquired == 0);
}
