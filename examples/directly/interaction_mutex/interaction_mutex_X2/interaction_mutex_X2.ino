...
#define DONE_PIN 7   // сигнал о завершении работы
#define X3_PIN 8     // сигнал от X3 о завершении работы
...
public:
    ...
    enum State {
        BEGIN, GO_WAIT, WAIT, 
        GO_UP_Z1, GO_LOW_Z1, GO_PICKUP_Z1, GO_UP_PICKUP_Z1, WAIT_DONE, GO_UP_PICKUP_Z3,
        GO_LOW_PICKUP_Z3, GO_DROP_Z3, GO_UP_Z3 
    };
    State state;

    void go_step(bool input_but, bool input_X3, bool m1_is_done, bool m2_is_done, bool m3_is_done, bool m4_is_done, 
        ...
        } else if (state == WAIT_DONE && input_X3) {
...
void loop() {
    ...
    bool input_X3 = digitalRead(X3_PIN);

    control.go_step(input_but, input_X3, true, true, true, true, true, true);
